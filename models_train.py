...
from rescnn_models import convolutional_model
...
def main(voxceleb_dir=c.DATASET_DIR):
    logging.info('Looking for audio [wav] files in {}.'.format(voxceleb_dir))
    ...
    while True:
        ...
        logging.info(batch.voxceleb_batch)
